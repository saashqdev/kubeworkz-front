...
export default {
    ...
    data() {
        return {
            ...
            twoWay: this.link.twoWay, // Should todo bidirectional marking be completed during link data sorting, or after the path object is completed?
        };
    },
    mounted() {
    ...
    computed: {
        path() {
            ...
            // The ratio of the arrow to the line segment (1/2 marks the midpoint)
