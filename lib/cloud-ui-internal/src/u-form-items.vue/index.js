...
export default {
    ...
    created() {
        console.warn('[proto-ui]', '<u-form-items>It will be abandoned later, please pass the combination as soon as possible<u-validater>Component approach to implement multi-input input content verification');
