...
/**
 * [PERIOD_OPTIONS All option values ​​of time interval options]
 * @type {Array}
 */
...
const initPeriodOptionsMethod = function (interval, ONE_MINUTE, sender) {
    ...
    // There are three values ​​in each column, take the second value
...
export default {
    ...
    watch: {
        ...
        date(value) {
            // If the period is set to invalid in a custom state, the period remains in the state before the switch.
