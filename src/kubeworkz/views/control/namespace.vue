...
import { niceBytes } from 'kubeworkz/utils/functional';

import valveMixin from 'kubeworkz/mixins/pipe/valve.mixin';
import uAppClusterSelect from 'kubeworkz/component/global/header/u-app-cluster-single.vue';
    ...
    methods: {
        async request() {
            try {
                ...
                if (this.tenant) {
                    params.labelSelector.push(`kubeworkz-tenant-${this.tenant}.tree.hnc.x-k8s.io/depth=2`);
                }
                if (this.project) {
                    params.labelSelector.push(`kubeworkz-project-${this.project}.tree.hnc.x-k8s.io/depth=1`);
                }
