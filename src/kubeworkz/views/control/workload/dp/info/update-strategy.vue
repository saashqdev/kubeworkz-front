<template>
  ...
  >
    <el-form-item style="display:flex;margin-bottom: 22px;" prop="spec.strategy.minReadySeconds">
      ...
      <el-input v-model="model.minReadySeconds" placeholder="Please enter an integer from 5-300"/>
    </el-form-item>
    <el-form-item style="display:flex;margin-bottom: 22px;" prop="spec.strategy.maxSurge">
      ...
      <el-input v-model="model.maxSurge" placeholder="Fill in the percentage or integer"/>
    </el-form-item>
    <el-form-item style="display:flex;margin-bottom: 22px;" prop="spec.strategy.maxUnavailable">
      ...
      <el-input v-model="model.maxUnavailable" placeholder="Fill in the percentage or integer"/>
    </el-form-item>
  </el-form-item>
</template>
