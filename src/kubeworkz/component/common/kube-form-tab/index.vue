...
export default {
    ...
    data() {
        return {
            ...
            cache: {},
            unwatch: {},
            transitionName: 'kubeworkz-tab-x-transition',
        };
    },
    computed: {
    ...
    methods: {
        ...
        chooseNext() {
            ...
            this.transitionName = 'kubeworkz-tab-x-transition';
            this.curTab = this.listLocal[(idx + 1) % this.listLocal.length].key;
        },
        choose(item) {

            this.transitionName = this.curTab < item.key ? 'kubeworkz-tab-x-transition' : 'kubeworkz-tab-x-reverse-transition';
