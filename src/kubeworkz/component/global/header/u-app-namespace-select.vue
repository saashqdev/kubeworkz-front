...
export async function loadNS({
    ...
    if (tenant) {
        params.labelSelector.push(`kubeworkz-tenant-${tenant.value}.tree.hnc.x-k8s.io/depth=2`);
    }
    if (project) {
        params.labelSelector.push(`kubeworkz-project-${project.value}.tree.hnc.x-k8s.io/depth=1`);
    }
